...
std::string HelpMessage()
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> for TCP (<port> + LIBTORRENT_PORT_OFFSET for TCP/UDP) default: 28333") + "\n";
    strUsage += "  -maxconnections=<n>    " + _("Maintain at most <n> connections to peers (default: 125)") + "\n";
    strUsage += "  -addnode=<ip>          " + _("Add a node to connect to and attempt to keep the connection open") + "\n";
    strUsage += "  -connect=<ip>          " + _("Connect only to the specified node(s). This option disables DNS lookup to research new peers.") + "\n";
    strUsage += "  -seednode=<ip>         " + _("Connect to a node to retrieve peer addresses, and disconnect") + "\n";
    strUsage += "  -externalip=<ip>       " + _("Specify your own public addresses for announce.") + "\n";
    strUsage += "  -onlynet=<net>         " + _("Only connect to nodes in network <net> (IPv4, IPv6, Tor, Ygg or Yggdrasil). This option does not prevent the peer from receiving incoming connections; use a firewall for that purpose.") + "\n";
    ...
    strUsage += "  -bind=<addr>           " + _("Bind to the specified interface addresses (or use all available interfaces if not defined)") + "\n";
